        ...
        <div name="skills" className="w-full min-h-screen h-fit bg-[#0a192f]">
            <div className="max-w-[1000px] mx-auto h-full w-full flex flex-col justify-center px-20  p-4">
                <div className="flex flex-col flex-end  items-start mt-10">
                    <p className="text-[#982d4f]  font-bold text-4xl">Experiance</p>
                ...
                <div className="flex flex-col justify-center items-center pt-20">
                    <p className="text-gray-300 font-bold text-3xl md:text-5xl text-center ">Check out my GitHub</p>
                    <a href="https://github.com/petarginic">
                        <button className="mt-6 flex justify-center items-center w-[160px]  text-white font-bold py-3 px-3 border-2 hover:bg-[#982d4f] hover:border-[#982d4f] hover:scale-110 duration-500">
