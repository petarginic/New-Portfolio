    ...
    return (
        <div name="home" className="w-full h-screen bg-[#0a192f] flex justify-center items-center">
            <div className="max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full">
                <p className="text-[#982d4f] font-bold text-2xl ">Hi, my name is</p>
                ...
                <p className="text-gray-300 font-bold pt-4 max-w-[500px]">
                ...
                <Link smooth={true} duration={500} to="skills">
                    <button className="mt-6 flex justify-center items-center w-[130px]  text-white font-bold py-3 px-3 border-2 hover:bg-[#982d4f] hover:border-[#982d4f] hover:scale-110 duration-500">
